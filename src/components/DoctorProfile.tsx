      ...
      <div className="container mx-auto px-4">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className={`${isVisible ? 'animate-fade-in' : 'opacity-0'} flex justify-center`} style={{ animationDelay: '0.2s' }}>
            <img 
              src="/images/34bf2c35-23c5-4777-954c-2c61b1890827.png"
          ...
          <div>
            ...
            <div 
              className={`mt-8 flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-6 items-center md:justify-start ${isVisible ? 'animate-fade-in' : 'opacity-0'}`}
              style={{ animationDelay: '0.7s' }} // Adjust delay as needed
            >
              <a href="https://oltn.sfd.co:300/" target="_blank" rel="noopener noreferrer" className="w-full md:w-auto">
                <Button
                  className="bg-primary hover:bg-secondary text-white font-medium px-6 py-3 rounded-md transition-colors w-full md:w-auto"
                >
                  Book Online Now
                </Button>
              </a>
              <a href="tel:02083991291" className="w-full md:w-auto">
                <Button
                  variant="outline"
                  className="border-primary text-primary hover:bg-primary hover:text-white font-medium px-6 py-3 rounded-md transition-colors w-full md:w-auto"
                >
                  Call Now
                </Button>
              </a>
