    ...
    >
      ...
      <div className="container mx-auto px-4 py-10 text-center text-white relative z-10 hero-content">
        <div className="max-w-4xl mx-auto">
          ...
          <div 
            className={`flex flex-col space-y-4 md:flex-row md:space-y-0 md:space-x-6 items-center md:justify-center md:items-baseline transition-all duration-1000 ease-out transform ${
              isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'
            }`}
          ...
          >
            <Button
              ...
              className="bg-white text-primary hover:bg-secondary hover:text-white text-sm md:text-lg px-6 md:px-8 py-4 md:py-6 rounded-lg transition-all duration-500 transform hover-lift shadow-lg w-full md:w-auto"
            >
              Book Free Consultation
            </Button>
            <a href="tel:02083991291" className="w-full md:w-auto">
              <Button
                className="bg-transparent border-2 border-white text-white hover:bg-white hover:text-primary text-sm md:text-lg px-6 md:px-8 py-4 md:py-6 rounded-lg transition-all duration-500 transform hover-lift w-full md:w-auto"
              >
                Call 020 8399 1291
              </Button>
            </a>
