...
const Footer = () => {
  ...
  const termsContent = (
    <div>
      ...
      <p className="mb-4">We provide dental implant services subject to professional assessment and suitability.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div>
            ...
            <p className="text-gray-300 mt-4">
              Providing exceptional dental implant services and transforming smiles in Esher.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4">
              <li className="flex items-start">
                ...
                <a href="tel:02083991291" className="hover:text-secondary transition-colors">020 8399 1291</a>
              </li>
              <li className="flex items-start">
                <Mail className="h-5 w-5 mr-3 text-secondary" aria-hidden="true" />
                <a href="mailto:surbiton@confidentalclinic.com" className="hover:text-secondary transition-colors">surbiton@confidentalclinic.com</a>
              </li>
              <li className="flex items-start">
                <MapPin className="h-5 w-5 mr-3 text-secondary" aria-hidden="true" />
                <address className="not-italic">359 Ewell Road<br />Surbiton<br />Surrey KT6 7BZ</address>
              </li>
            </ul>
          </div>
        </div>
