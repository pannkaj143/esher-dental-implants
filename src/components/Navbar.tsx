        ...
        <div className="flex justify-between items-center">
          ...
          <div className="hidden md:flex items-center space-x-8">
            ...
            <div className="flex space-x-4">
              <a href="https://www.facebook.com/myconfidentalclinic" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
            ...
            <a href="https://oltn.sfd.co:300/" target="_blank" rel="noopener noreferrer">
              <Button 
        ...
        {isMobileMenuOpen && (
          ...
          >
            <div className="flex flex-col space-y-4 p-4">
              ...
              <a href="https://oltn.sfd.co:300/" target="_blank" rel="noopener noreferrer" className="w-full">
                <Button
                  role="menuitem"
